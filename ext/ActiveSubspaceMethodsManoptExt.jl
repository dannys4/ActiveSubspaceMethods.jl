...
function (as::ActiveSubspacesXXManopt)()
    ActiveSubspacesXXManoptOutput(as)
end
...
function ASXX_manopt_riem_grad(U_perp, as::ActiveSubspacesXXManopt)
    ...
    2*(I - U_perp*U_perp')*(as.C_AS - C_ZZ_perp)*U_perp
end

function (out::ActiveSubspacesXXManoptOutput)(r::Int; start_mat=nothing, manopt_opt=quasi_Newton)
